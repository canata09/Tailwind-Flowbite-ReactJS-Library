    ...
    return (
        <div className="App">
            ...
            <div class="container-fluid mx-auto">
                <div class="p-4 bg-white border border-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div class="space-y-3  flex flex-wrap">
                        ...
                        <div class="relative float-left w-full flex items-start mb-3 me-4 items-center md:items-start flex-col border-b border-gray-200 ">
                            <Navabar />
                        </div>
                        <div class="relative float-left lg:max-w-7xl w-[calc(100%-85%)] flex items-start mb-3 me-4 items-center md:items-start flex-col border-b border-gray-200 ">
                        ...
                        <div class="relative float-left lg:max-w-7xl w-[calc(100%-80%)] flex items-start mb-3 me-4 items-center md:items-start flex-col border-b border-gray-200 ">
                        ...
                        <div class="relative float-left lg:max-w-7xl w-[calc(100%-50%)] flex items-start mb-3 me-4 items-center md:items-start flex-col border-b border-gray-200 ">
                        ...
                        <div class="relative float-left lg:max-w-7xl w-[calc(100%-30%)] ml-[calc(100%-85%)] flex items-start mb-3 me-4 items-center md:items-start flex-col border-b border-gray-200 ">
                            <div id="marketing-banner" tabindex="-1" class="relative flex flex-col justify-between w-[calc(100%-2rem)] p-4 -translate-x-1/2 bg-white border border-gray-100 rounded-lg shadow-sm lg:max-w-7xl left-1/2 top-6 dark:bg-gray-700 dark:border-gray-600">
                                <div class="flex items-start mb-3 me-4 items-center md:items-start flex-col border-b border-gray-200 ">
                                    <a href="https://flowbite.com/" class="flex items-center mb-2 border-gray-200 md:mb-0 dark:border-gray-600">
                                        <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
